...
public interface EventOutboxRepository
    ...
    @Query("""
            ...
            SET e.status = org.vippro.ledger_service.model.OutboxStatus.NEW,
                e.processingStartedAt = NULL,
                e.nextRetryAt = :now,
                e.lastError = :reason
            WHERE e.status = org.vippro.ledger_service.model.OutboxStatus.PROCESSING
